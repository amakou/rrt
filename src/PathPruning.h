...
template <typename T>
MatrixXd NHRRT_PATH_PRUNING_POSITION_MOD3(MatrixXd matPathFinal, setting_t P, T world, double dMaxBeta)
{
	int flag, n, j, i;
	...
	matFinalPoint.resize( 1 + matFinalPoint_E.rows() + 3, matPathFinal.cols() );
