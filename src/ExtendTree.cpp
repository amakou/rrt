...
/*
extendTreeR_t ExtendTree_NHC_Sort_OnlyGS_TermCond(MatrixXd tree, VectorXd vecEndNode, world_t world, setting_t P,
        double dKmax, double c4, double dMax, double dMaxBeta, sigma_t sigma, int iMaxIte, int iINDC)
{
  ...
  double p, r, theta, Sx, Sy, palt, d_pre;
...
/*
extendTreeR_t ExtendTree_NHC_Sort_GS_TermCond(MatrixXd tree, VectorXd vecEndNode, world_t world, setting_t P,
	double dKmax, double c4, double dMax, double dMaxBeta, sigma_t sigma, int iMaxIte, int iINDC)
{
  int iFlag, ii, jj, kk, iTemp, n, idx, flagRet;
  double p, r, theta, Sx, Sy, palt, d_pre;
...
/*
extendTreeR_t ExtendTree_NHC_Sort_NoGS_NoTermCond(MatrixXd tree, VectorXd vecEndNode, world_t world, setting_t P,
	double dKmax, double c4, double dMax, double dMaxBeta, sigma_t sigma, int iMaxIte, int iINDC)
{
  int iFlag, ii, jj, kk, iTemp, n, idx, flagRet;
  double p, r, theta, Sx, Sy, palt, d_pre;
